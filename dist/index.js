(function (global, factory) {
    ...
    */
    ...
    DrawProgram$1.prototype._specifyDataForShaderProgram = function _specifyDataForShaderProgram (gl, shaderProgram, attributeName, itemSize, stride, offset) {
    ...
    DrawProgram$1.prototype.drawTile = function drawTile (matrix, tile, opacity)
    {
    ...
    */
    ...
    var msdf = 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAgAAAAEACAIAAABK8lkwAAFos0lEQVR42uxdB1xUx/Mfo1HEDpbYsKBib8GCUp7dmCia2FvU2KJiQVRsgGJBFEHAjmgESyzYUEQpz27UiDFRozEWrD\
...
YAAAAASUVORK5CYII=';
    ...
    DrawProgram.prototype.draw = function draw (layer, opacity)
    {
    ...
    DrawProgram.prototype.specifyData = function specifyData (attribute_name, itemSize, stride, offset) {
    ...
    //    this.renderer = new Renderer(this.gl, this._container, this.ssctrees);
        ...
        //    zoomButtonHandler(this) // --> if the buttons are not there
    ...
    //        backgroundRenderer,
            new BackgroundRenderer(this.getWebGLContext(), this.msgbus),
            new WMTSRenderer(this.getWebGLContext(), this.msgbus, "2020_ortho25", true),
            // new WMTSRenderer(this.getWebGLContext(), this.msgbus, "lufolabels", false),
    ...
    */
    ...
    PdokSuggestWidget.prototype.updateHighlight = function updateHighlight ()
    {
        ...
        for (var i$1=0; i$1 < childs.length; i$1++) 
        {
            childs[i$1].classList.remove("is-active");
            childs[i$1].classList.add("small");
        }
        if (childs.length > 0 && this.state.highlight >= 0 && this.state.highlight < childs.length) // FIXME:or length-1?
        {
            ...
            childs[i].classList.remove("small");
        }
    };
